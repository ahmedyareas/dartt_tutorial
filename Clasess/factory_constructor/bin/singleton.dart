...
// You can create a singleton in Dart by defining a factory constructor ,
//that always returns the same instance.
//It is mostly useful when you want to create a single instance of a class and ,
//use it throughout the application like database connection app.
